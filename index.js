...
if(idEleven_Krishnaja_WeekFund) {
  idElevenFund.textContent = `${idEleven_Krishnaja_WeekFund}`;
} else {
...
const idTwelveFund = document.getElementById('idTwelveFund');

idTwelveName.textContent = 'Vishnuja';

if(idTwelve_Vishnuja_WeekFund) {
  idTwelveFund.textContent = `${idTwelve_Vishnuja_WeekFund}`;
} else {
  idTwelveFund.textContent = 'Not Paid';
  idTwelveFund.style.color = 'red';
}


// ID THIRTEEN 13 MALU
const idThirteenName = document.getElementById('idThirteenName');
const idThirteenFund = document.getElementById('idThirteenFund');

idThirteenName.textContent = 'Malu';

if(idThirteen_Malu_WeekFund) {
  idThirteenFund.textContent = `${idThirteen_Malu_WeekFund}`;
} else {
  idThirteenFund.textContent = 'Not Paid';
